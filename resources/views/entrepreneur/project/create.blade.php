            ...
            <div class="col-md-12">
                <div class="card shadow border-0">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('entrepreneur.project.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <p class="small text-muted">
                                After submission, your project will be reviewed by our entrepreneur team. If approved, you will
                                earn badges like
